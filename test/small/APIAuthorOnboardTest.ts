...
describe("Small Test onboarding APIs of APIAuthor", function() {
    describe("Test APIAuthor#onboardWithThingID", function() {
        ...
        describe("handle succeeded reponse", function() {
            ...
            it("test callback", function (done) {
                au.onboardWithThingID(request,(err, result)=>{
                    try{
                        expect(err).to.null;
                        expect(result).to.be.deep.equal(expectedResult);
                        done();
        ...
        describe("handle err reponse", function() {
            ...
            it("test callback", function (done) {
                au.onboardWithThingID(request,(err, cmd)=>{
                    try{
                        expect(err).to.be.deep.equal(expectedError);
                        expect(cmd).to.null;
                        done();
    ...
    describe("Test APIAuthor#onboardWithVendorThingID", function() {
        ...
        describe("handle succeeded reponse", function() {
            ...
            it("test callback", function (done) {
                au.onboardWithVendorThingID(request,(err, result)=>{
                    try{
                        expect(err).to.null;
                        expect(result).to.be.deep.equal(expectedResult);
                        done();
        ...
        describe("handle err reponse", function() {
            ...
            it("test callback", function (done) {
                au.onboardWithVendorThingID(request,(err, cmd)=>{
                    try{
                        expect(err).to.be.deep.equal(expectedError);
                        expect(cmd).to.null;
                        done();
