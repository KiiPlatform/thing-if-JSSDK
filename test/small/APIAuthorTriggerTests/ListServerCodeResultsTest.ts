...
describe("Small Test APIAuthor#listServerCodeResults", function() {
    describe("handle http response", function() {
        ...
        describe("hanle success response", function(){
            ...
            it("test promise", function (done) {
                au.listServerCodeExecutionResults(target, triggerID)
            ...
            it("test callback", function (done) {
                au.listServerCodeExecutionResults(target, triggerID, null, (err, results)=>{
                    try{
                        expect(err).to.null;
                        expect(results).to.be.deep.equal(expectedResults);
                        done();
